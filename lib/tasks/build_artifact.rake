...
task :build_artifact => [:build_dummy_artifact] do |task|
  ...
  license        = 'Apache-2.0'
  description    = 'AngularJS frontend for UiTdatabank'
  ...
  uitdatabank_angular_artifact = Dir.glob('pkg/uitdatabank-angular_*.deb').sort.last
  uitdatabank_angular_version  = `dpkg -f #{uitdatabank_angular_artifact} Version`.chomp
